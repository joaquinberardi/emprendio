...
CREATE TABLE `usuarios` (
  ...
  `TiempoCreacion` varchar(500) DEFAULT NULL,
  `Historia` text,
  `Integrantes` text,
  `Empleados` text,
...
-- Dump completed on 2020-11-09 14:10:54
